...
public class ManageFeatureFlagsHandlerTests
{
    private static ManageFeatureFlagsHandler CreateHandler() => new();
    ...
    {
        var requirement = new ManageFeatureFlagsRequirement();
